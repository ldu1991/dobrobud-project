...
$args = array(
	...
	'menu_type'            => 'menu',
	'allow_sub_menu'       => true,
	'menu_title'           => __( 'Dobrobud', 'ld' ),
	'page_title'           => __( 'Dobrobud', 'ld' ),
	'google_api_key'       => '',
...
Redux::setSection( $opt_name, array(
	'title'            => __( 'Дополнительные данные', 'ld' ),
	...
	'fields'           => array(
		array(
            'id'        => 'googlemap-apikey',
            'type'      => 'text',
            'title'     => __('Ключи API Google', 'ld'),
            'subtitle'  => __(' ', 'ld'),
		),
		array(
            'id'        => 'go-analit',
            'type'      => 'textarea',
            'title'     => __('Google Analytics', 'ld'),
            'subtitle'  => __(' ', 'ld'),
		),
		array(
            'id'        => 'ya-metrika',
            'type'      => 'textarea',
            'title'     => __('Yandex.Metrika', 'ld'),
            'subtitle'  => __(' ', 'ld'),
		),
		array(
            'id'        => 'dop-code',
            'type'      => 'textarea',
            'title'     => __('Дополнительный код', 'ld'),
            'subtitle'  => __('Дополнительное поле для вставки иных счетчиков, форм обратной связи и т.п.', 'ld'),
		),
	)
) );

Redux::setSection( $opt_name, array(
	'title'            => __( 'Контактные данные', 'ld' ),
	'id'               => 'contacts-info',
	'icon'             => 'el el-cogs',
	'customizer_width' => '500px',
	'fields'           => array(
        array(
            'id'       => 'contact-center',
            'type'     => 'multi_text',
            'title'    => __( 'Контакт центр', 'ld' ),
            'subtitle' => __( 'Укажите один или несколько контактных телефонов', 'ld' ),
        ),
        array(
            'id'       => 'otdel-kadrov',
            'type'     => 'multi_text',
            'title'    => __( 'Отдел кадров', 'ld' ),
            'subtitle' => __( 'Укажите один или несколько контактных телефонов', 'ld' ),
        ),
        array(
            'id'       => 'bugalter',
            'type'     => 'multi_text',
            'title'    => __( 'Бухгалтер', 'ld' ),
            'subtitle' => __( 'Укажите один или несколько контактных телефонов', 'ld' ),
        ),
		array(
            'id'        => 'rukovodit-1',
            'type'      => 'textarea',
            'title'     => __('Руководство компании #1', 'ld'),
            'subtitle'  => __('', 'ld'),
		),
		array(
            'id'        => 'rukovodit-2',
            'type'      => 'textarea',
            'title'     => __('Руководство компании #2', 'ld'),
            'subtitle'  => __('', 'ld'),
		),
